...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneTweenGroup = function (_Component) {
	  _inherits(OneTweenGroup, _Component);
	
	  function OneTweenGroup() {
	    _classCallCheck(this, OneTweenGroup);
	
	    var _this = _possibleConstructorReturn(this, (OneTweenGroup.__proto__ || Object.getPrototypeOf(OneTweenGroup)).apply(this, arguments));
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.getCoverAnimation = function (child, i, type) {
	    ...
	    var children = _react2.default.createElement(_OneTween2.default, _extends({}, child.props, {
	  ...
	  this.getChildrenToRender = function (children) {
	    return children.map(function (child, i) {
	      ...
	      return _this3.isTween[child.key] && _this3.getCoverAnimation(child, i, _this3.isTween[child.key]) || _react2.default.createElement(_OneTween2.default, _extends({}, child.props, { component: child.type, key: child.key }));
	    });
	  };
	};

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SliderItem = __webpack_require__(222);
	
	var _SliderItem2 = _interopRequireDefault(_SliderItem);
	
	var _SliderDots = __webpack_require__(223);
	
	var _SliderDots2 = _interopRequireDefault(_SliderDots);
	
	var _SliderArrows = __webpack_require__(224);
	  ...
	  _createClass(Slider, [{
	    ...
	    value: function render() {
	      ...
	      var itemNodes = this.props.items.map(function (item, idx) {
	        return _react2.default.createElement(_SliderItem2.default, { item: item, count: count, size: size, key: 'item' + idx });
	      });
	  ...
	  _createClass(SliderItem, [{
	    ...
	    value: function render() {
	      ...
	      if ("size7" == this.props.size) {
	        var _props2 = this.props,
	            _count = _props2.count,
	            _item = _props2.item;
	
	        var _width = 100 / _count + '%';
	        return _react2.default.createElement(
	          'li',
	          { className: 'slider-item', style: { width: _width } },
	          _react2.default.createElement('img', { src: _item.src, alt: _item.alt })
	        );
	      }
	    }
	  }]);

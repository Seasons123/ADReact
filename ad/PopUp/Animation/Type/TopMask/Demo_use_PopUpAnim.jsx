...
import PopupStore from '../../PopUpAnim/Store';
import Header from '../../PopUpAnim/Header';
import Footer from '../../PopUpAnim/Footer';
import Constants from '../../PopUpAnim/Constants';

const displayName = 'TopMask';
const propTypes = {
...
export default class TopMask extends React.Component {
    ...
    constructor(props) {
        ...
        initialState.closeOnOutsideClick = this.props.data.closeOnOutsideClick;
     ...
     */
    _containerClick(e) {
        if (this.state.closeOnOutsideClick && this.hasClass(e.target, this.props.data.className)) {
    ...
    className(className) {
        return this.props.data.className + '__' + className;
    }
    ...
    wildClass(className, base) {
        ...
        if (this.props.data.wildClasses) {
            return className;
        }
    ...
    render() {
        ...
        if (this.state.visible) {
            ...
            className += ' ' + this.props.data.className + '--visible';

            if (this.props.data.closeBtn) {
                closeBtn = <button onClick={this.handleCloseEvent} className={this.props.data.className + '__close'}>{this.props.data.closeHtml}</button>;
            }
            ...
            box = (
                <article ref="box" style={{opacity: 0}} className={boxClass}>
                    ...
                    <Footer
                        ...
                        wildClasses={this.props.data.wildClasses}
                        btnClass={this.props.data.btnClass}
                        buttonClick={this.handleButtonClick}
                        onClose={this.handleCloseEvent}
                        onOk={this.handleCloseEvent}
                        defaultOk={this.props.data.defaultOk}
                        defaultCancel={this.props.data.defaultCancel}
...
TopMask.displayName = displayName;
TopMask.propTypes = propTypes;
TopMask.defaultProps = defaultProps;
